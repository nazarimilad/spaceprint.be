window.addEventListener("load", function () {
    ...
    var w = 1070, h = 300;
    var achtergrondskleur = new THREE.Color("rgb(255, 255, 255)")
    var renderer = new THREE.WebGLRenderer();
    renderer.setClearColor(achtergrondskleur);
    ...
    var modelkleur = new THREE.Color("rgb(26, 188, 156)");
    

    var mat = new THREE.MeshPhongMaterial({
        color: modelkleur, ambient: modelkleur, specular: modelkleur, wireframe: true
    });
